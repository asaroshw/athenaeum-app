...
def generate_comprehensive_report(metrics, ticker):
    ...
    return client.models.generate_content(model='gemini-1.5-pro-002', contents=pmt, config=types.GenerateContentConfig(system_instruction=sys, temperature=0.2)).text
