...
def generate_comprehensive_report(metrics, ticker):
    ...
    return client.models.generate_content(model='gemini-2.5-flash', contents=pmt, config=types.GenerateContentConfig(system_instruction=sys, temperature=0.2)).text
