...
def resolve_name_to_ticker(stock_input: str) -> str:
    ...
    # Check if user already typed an explicit symbol with suffix
...
def analyze(ticker: str):
    try:
        ...
        resolved = resolve_name_to_ticker(clean_query)
        ...
        raise HTTPException(status_code=400, detail=f"Stock query failed: {str(e)}")
